      ...
      <div className="flex flex-col md:flex-row py-16 max-w-6xl w-full px-6 mx-auto">
          <div className='flex-1 max-w-4xl'>
              <h1 className="text-3xl font-medium mb-6">
                  Shopping Cart <span className="text-sm text-indigo-500">{totalCartItems()} Items</span>
              </h1>

              {cartItems.length>0 ? <div className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 text-base font-medium pb-3">
          ...
          <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
              ...
              <div className="mb-6">
                  ...
                  <div className="relative flex justify-between items-start mt-2">
                      ...
                      {showAddress && (
                          <div className="absolute top-6 py-1 bg-white border border-gray-300 text-sm w-full cursor-pointer shadow-md">
                              ...
                              <p className='text-indigo-500 text-center cursor-pointer p-2 hover:bg-indigo-500/10'>Add Address</p>
                          </div>
                      )}
                  </div></>): <p className='text-gray-400 mt-3 text-md'>Login to enter</p>}
              ...
              <div className="text-gray-500 mt-4 space-y-2">
                  ...
                  <p className="flex justify-between text-lg font-medium mt-3">
                      <span>Total Amount:</span><span>&#8377;{Math.floor(totalCartAmount()*102)/100}</span>
                  </p>
              </div>
